window.onload = function() {
  ...
  // 路線の選択肢
  station_s = document.getElementById("station_s");

  // 都道府県の選択肢が変更された際の動作
  line = document.getElementById("line");
  line.onchange = chgLine;
...
function chgLine() {
  ...
  // 変更後のカテゴリを取得
  var AftLine = line.value;

  // 選択肢ごとに関数を呼び出し
  if (AftLine == "line11101") {
    setLine111011();
...
// 路線の選択肢を設定する
function setLine111011() {

  // 選択肢を空にする
  station_s.textContent = null;

  // 選択肢を設定
  var lines = [
  
		{cd:"stn1110101", label:"函館"},
		{cd:"stn1110102", label:"五稜郭"},
		{cd:"stn1110103", label:"桔梗"},
		{cd:"stn1110104", label:"大中山"},
		{cd:"stn1110105", label:"七飯"},
		{cd:"stn1110106", label:"新函館北斗"},
		{cd:"stn1110107", label:"仁山"},
		{cd:"stn1110108", label:"大沼"},
		{cd:"stn1110109", label:"大沼公園"},
		{cd:"stn1110110", label:"赤井川"},
		{cd:"stn1110111", label:"駒ケ岳"},
		{cd:"stn1110112", label:"東山"},
		{cd:"stn1110113", label:"姫川"},
		{cd:"stn1110114", label:"池田園"},
		{cd:"stn1110115", label:"流山温泉"},
		{cd:"stn1110116", label:"銚子口"},
		{cd:"stn1110117", label:"鹿部"},
		{cd:"stn1110118", label:"渡島沼尻"},
		{cd:"stn1110119", label:"渡島砂原"},
		{cd:"stn1110120", label:"掛澗"},
		{cd:"stn1110121", label:"尾白内"},
		{cd:"stn1110122", label:"東森"},
		{cd:"stn1110123", label:"森"},
		{cd:"stn1110124", label:"桂川"},
		{cd:"stn1110125", label:"石谷"},
		{cd:"stn1110126", label:"本石倉"},
		{cd:"stn1110127", label:"石倉"},
		{cd:"stn1110128", label:"落部"},
		{cd:"stn1110129", label:"野田生"},
		{cd:"stn1110130", label:"山越"},
		{cd:"stn1110131", label:"八雲"},
		{cd:"stn1110132", label:"鷲ノ巣"},
		{cd:"stn1110133", label:"山崎"},
		{cd:"stn1110134", label:"黒岩"},
		{cd:"stn1110135", label:"北豊津"},
		{cd:"stn1110136", label:"国縫"},
		{cd:"stn1110137", label:"中ノ沢"},
		{cd:"stn1110138", label:"長万部"},
